...
class QVinaDockingTask(BaseDockingTask):
    ...
    @classmethod
    def from_generated_mol(cls, ligand_rdmol, ligand_filename, protein_root='./data/crossdocked_pocket10', **kwargs):
        # load original pdb
        protein_fn = os.path.join(
    ...
    @classmethod
    def from_original_data(cls, data, ligand_root='./data/crossdocked_pocket10', protein_root='./data/crossdocked_pocket10',
                           **kwargs):
        protein_fn = os.path.join(
            os.path.dirname(data.ligand_filename),
